...
?>
    ...
    <tr>
   	 <td  colspan="2"><h3>حسابات فروش به شرکت <?=$rname?></h3></td>
 	</tr>
    <tr><td valign="top">
...
$result = $dbase->query("SELECT * FROM sob_money where mon_stat=0 and mon_eoe=2 $where ");
		$paid = 0;
while($row = $dbase->fetch_array($result))
  {
	$et=$row['mon_eoe'];
...
<tr  class="tox"  >
    ...
    <tr class="toxz" >
         ...
         <td colspan="1" >مجموعه پول دریافت شده</td>
