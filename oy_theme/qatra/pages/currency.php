...
<form method="post" name="add"  id="oilexp" lang="fa">
  ...
  <tr>
    ...
    <td width="80">
      ...
      <input class="btn btn-success btn-sm Pull-left" data-url="<?php echo HOME ?>?pg=currency #reportx" id="load_reportx" type="button" name="Send" value="<?php echo g_lbl('add') ?>"
    onclick="javascript: formget(this.form,'<?php echo HOME ?>?pg=currency&add=1'); ;" >
...
?></td><td></td>
  ...
  <tr>
    ...
    <td width="80">
      ...
      <input class="btn btn-success btn-sm Pull-left" data-url="<?php echo HOME ?>?pg=currency #reportx" id="load_reportx" type="button" name="Send" value="<?php echo g_lbl('edit') ?>"
    onclick="javascript: formget(this.form,'<?php echo HOME ?>?pg=currency&edit=1'); " >
...
?><</td>
     <td width="80">
      ...
      <input class="btn btn-success btn-sm Pull-left" data-url="<?php echo HOME ?>?pg=currency #reportx" id="load_reportx" type="button" name="Send" value="<?php echo g_lbl('delete') ?>"
    onclick="javascript: formget(this.form,'<?php echo HOME ?>?pg=currency&del=1'); ;" >
...
<?php
global $dbase;
$result = $dbase->query("SELECT * FROM sob_categories_oy where cat_type='currency'   ORDER BY cat_id DESC LIMIT 12");?>
